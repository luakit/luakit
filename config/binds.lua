...
binds.mode_binds = {
    ...
    normal = {
        ...
        buf("^Fy$",                     function (w) w:set_mode("follow", "yank",       function (uri) w:set_selection(uri) end) end),
        buf("^FY$",                     function (w) w:set_mode("follow", "yankdesc",   function (des) w:set_selection(uri) end) end),
        buf("^Ft$",                     function (w) w:set_mode("follow", "tab",        function (uri) w:set_selection(uri) end) end),
        buf("^Fo$",                     function (w) w:set_mode("follow", "open",       function (uri) w:set_selection(uri) end) end),
        buf("^Fw$",                     function (w) w:set_mode("follow", "win",        function (uri) w:set_selection(uri) end) end),
        buf("^FT$",                     function (w) w:set_mode("follow", "tabprompt",  function (uri) w:enter_cmd(":tabopen ".. uri) end) end),
        buf("^FO$",                     function (w) w:set_mode("follow", "openprompt", function (uri) w:enter_cmd(":open ".. uri) end) end),
        buf("^FW$",                     function (w) w:set_mode("follow", "winprompt",  function (uri) w:enter_cmd(":winopen ".. uri) end) end),
        buf("^Fs$",                     function (w) w:set_mode("follow", "save",       function (uri)  end) end),
        buf("^Ff$",                     function (w) w:set_mode("follow", "focus",                         ) end),
        buf("^Fc$",                     function (w) w:set_mode("follow", "context",    function ()     end) end),
        buf("Fi",                       function (w) w:set_mode("follow", "image",      function (uri)  end) end),
