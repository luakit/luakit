...
binds.mode_binds = {
    ...
    normal = {
        ...
        -- Link following
        key({},          "f",           function (w) w:set_mode("follow", "follow",     function (sig) w:emit_form_root_active_signal(sig) end) end),
        key({},          "Fy",          function (w) w:set_mode("follow", "yank",       function (uri) w:set_selection(uri) end) end),
        key({},          "FY",          function (w) w:set_mode("follow", "yankdesc",   function (des) w:set_selection(uri) end) end),
        key({},          "Ft",          function (w) w:set_mode("follow", "tab",        function (uri) w:set_selection(uri) end) end),
        key({},          "Fo",          function (w) w:set_mode("follow", "open",       function (uri) w:set_selection(uri) end) end),
        key({},          "Fw",          function (w) w:set_mode("follow", "win",        function (uri) w:set_selection(uri) end) end),
        key({},          "FT",          function (w) w:set_mode("follow", "tabprompt",  function (uri) w:enter_cmd(":tabopen ".. uri) end) end),
        key({},          "FO",          function (w) w:set_mode("follow", "openprompt", function (uri) w:enter_cmd(":open ".. uri) end) end),
        key({},          "FW",          function (w) w:set_mode("follow", "winprompt",  function (uri) w:enter_cmd(":winopen ".. uri) end) end),
        key({},          "Fs",          function (w) w:set_mode("follow", "save",       function (uri)  end) end),
        key({},          "Ff",          function (w) w:set_mode("follow", "focus",                         ) end),
        key({},          "Fc",          function (w) w:set_mode("follow", "context",    function ()     end) end),
        key({},          "Fi",          function (w) w:set_mode("follow", "image",      function (uri)  end) end),
