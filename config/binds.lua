...
binds.mode_binds = {
    ...
    normal = {
        ...
        -- Link following
        key({},          "f",           function (w) w:set_mode("follow", "follow") end),
        buf("^Fy$",                     function (w) w:set_mode("follow", "yank",       luakit.set_selection) end),
        buf("^FY$",                     function (w) w:set_mode("follow", "yankdesc",   luakit.set_selection) end),
        buf("^Ft$",                     function (w) w:set_mode("follow", "tab",        luakit.set_selection) end),
        buf("^Fo$",                     function (w) w:set_mode("follow", "open",       luakit.set_selection) end),
        buf("^Fw$",                     function (w) w:set_mode("follow", "win",        luakit.set_selection) end),
