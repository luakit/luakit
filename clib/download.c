 ...
 *
 * Converts the given destination to a file:// URI.
 *
 * \param L The Lua VM state.
 * \param download The \ref download_t of the download.
 *
 * \luastack
 * \lvalue The download to modify.
 ...
 *
 * - clears the error message of the download
