/*
 * common/luah.h - Lua helper functions
 *
...
#ifndef LUAKIT_COMMON_LUAH_H
#define LUAKIT_COMMON_LUAH_H
...
#define luaH_deprecate(L, repl) \
    do { \
        ...
        signal_object_emit(L, luakit_class.signals, "debug::deprecation", 1, 0); \
    } while(0)
